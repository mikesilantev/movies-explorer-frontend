  ...
  async function getSavedMoviesApi() {
    ...
    if (token) {
      try {
        ...
        console.log('savedMoviesCurrentUser', savedMoviesCurrentUser)
    ...
    <CurrentUserContext.Provider value={currentUser}>
      <Routes>
        <Route path="/" element={<AppLayout loggedIn={loggedIn} />}>
          ...
          <Route element={<ProtectedRoute loggedIn={loggedIn} correctToken={correctToken} />}>
            <Route
              path="movies"
              element={
                <Movies
        ...
        {!loggedIn && (
          <Route path="/signup" element={<Register handleSignup={handleSignup} apiTextError={apiTextError} />} />
        )}
        {!loggedIn && (
          <Route path="/signin" element={<Login handleSignin={handleSignin} apiTextError={apiTextError} />} />
        )}
